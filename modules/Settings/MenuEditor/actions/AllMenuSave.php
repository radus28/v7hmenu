...
class Settings_MenuEditor_AllMenuSave_Action extends Settings_Vtiger_Index_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		if ($selectedModulesList) {
			...
			$menuEditorModuleModel->saveAllMenuStruncture();
		}
        
		$loadUrl = $menuEditorModuleModel->getAllMenuIndexViewUrl();
