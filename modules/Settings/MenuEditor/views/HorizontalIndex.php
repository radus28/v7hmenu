...
class Settings_MenuEditor_HorizontalIndex_View extends Settings_Vtiger_Index_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->view('HorizontalIndex.tpl', $qualifiedModuleName);
	}
	...
	function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array(
			"modules.Settings.$moduleName.resources.HorizontalMenuEditor",
		);
