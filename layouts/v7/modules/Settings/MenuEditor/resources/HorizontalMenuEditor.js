 ...
 * All Rights Reserved.
 *************************************************************************************/
jQuery.Class('Settings_HorizontalMenu_Editor_Js', { }, {
    ...
    getForm: function () {
        if (this.menuEditorForm == false) {
            this.menuEditorForm = jQuery('#menuEditor');
        }
...
jQuery(document).ready(function () {
    var settingMenuEditorInstance = new Settings_HorizontalMenu_Editor_Js();
